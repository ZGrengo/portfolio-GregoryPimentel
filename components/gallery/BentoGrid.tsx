...
export function BentoGrid({ images, onSelect, isMobileView = false }: BentoGridProps) {
    ...
    return (
      <div className="space-y-4">
        ...
        <div
          ...
          className="group relative cursor-pointer overflow-hidden rounded-lg bg-slate-900 dark:bg-slate-900 [.light_&]:bg-[#f7f9f9] border border-white/20 dark:border-white/20 [.light_&]:border-[#0a2e36]/30 transition-all duration-300 hover:border-white/30 dark:hover:border-white/30 [.light_&]:hover:border-[#0a2e36]/40 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-palette-blue/20 dark:hover:shadow-palette-blue/20 [.light_&]:hover:shadow-[#00a676]/20"
        >
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div
        onClick={() => onSelect(heroIndex)}
        className="group relative cursor-pointer overflow-hidden rounded-lg bg-slate-900 dark:bg-slate-900 [.light_&]:bg-[#f7f9f9] border border-white/20 dark:border-white/20 [.light_&]:border-[#0a2e36]/30 transition-all duration-300 hover:border-white/30 dark:hover:border-white/30 [.light_&]:hover:border-[#0a2e36]/40 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-palette-blue/20 dark:hover:shadow-palette-blue/20 [.light_&]:hover:shadow-[#00a676]/20 md:col-span-2 md:row-span-2"
      >
