export const translations = {
  es: {
    ...
    about: {
      ...
      paragraph1: "Soy ingeniero de sistemas y desarrollador full stack, enfocado en construir productos digitales que resuelven problemas reales.",
      paragraph2: "Mi trayectoria es poco convencional: mientras trabajaba en cocina detecté ineficiencias en la gestión de comandas y desarrollé una aplicación que hoy está en producción en más de 10 restaurantes, con previsión de escalar al resto de la compañía. Gracias a esta herramienta, el local donde trabajo alcanzó el top 10 de restaurantes más rápidos del país durante varios meses consecutivos.",
    ...
    timeline: {
      ...
      items: {
        goikounter: {
          ...
          description: "Diseñé y desarrollé una herramienta de optimización de comandas nacida desde operación real, actualmente desplegada en +10 locales, con visión de escalar al resto de la compañía.",
          highlights: [
            "Enfocado en eficiencia operativa y reducción de errores",
            "Entrega iterativa y mejoras basadas en feedback real",
          ],
        },
        bootcamp: {
          ...
          org: "HACK A BOSS",
          period: "2024 - 2025",
          description: "Formación intensiva en desarrollo web full stack con enfoque práctico y trabajo en equipo.",
          highlights: ["React, Node.js, MySQL", "Scrum / Scrumban"],
        },
        practicas: {
        ...
        ingenieria: {
          ...
          org: "Universidad",
          period: "2014 — 2020",
          description: "Base sólida en programación, sistemas y resolución de problemas con enfoque lógico y estructurado.",
        },
        cocina: {
  ...
  en: {
    ...
    projects: {
      ...
      descriptions: {
        goikounter: "Kitchen order optimization developed from real operations.\n\nIn production in +10 restaurants, with direct impact on speed and efficiency. With vision to scale to the entire company.",
    ...
    about: {
      ...
      paragraph1: "I'm a systems engineer and full stack developer, focused on building digital products that solve real problems.",
      paragraph2: "My journey is unconventional: while working in a kitchen, I detected inefficiencies in order management and developed an application that is now in production in more than 10 restaurants, with plans to scale to the rest of the company. Thanks to this tool, the restaurant where I work reached the top 10 fastest restaurants in the country for several consecutive months.",
    ...
    timeline: {
      ...
      items: {
        goikounter: {
          ...
          period: "2025 — Present",
          description: "I designed and developed an order optimization tool born from real operations, currently deployed in +10 locations, with a vision to scale to the rest of the company.",
          highlights: [
            "Focused on operational efficiency and error reduction",
            "Iterative delivery and improvements based on real feedback",
          ],
        },
        bootcamp: {
          ...
          org: "HACK A BOSS",
          period: "2024 - 2025",
          description: "Intensive training in full stack web development with a practical approach and teamwork.",
          highlights: ["React, Node.js, MySQL", "Scrum / Scrumban"],
        },
        practicas: {
        ...
        ingenieria: {
          ...
          org: "University",
          period: "2014 — 2020",
          description: "Solid foundation in programming, systems and problem solving with a logical and structured approach.",
        },
        cocina: {
